...
export const PureDarkTheme = createTheme({
  ...
  palette: {
    common: {
      white: colors.alpha.black[100],
      black: colors.alpha.white[100],
    },
    mode: "dark",
    primary: {
    ...
    action: {
      ...
      selectedOpacity: 0.1,
      disabled: colors.alpha.white[50],
      disabledBackground: colors.alpha.white[5],
  ...
  components: {
    ...
    MuiTabs: {
      styleOverrides: {
        ...
        indicator: {
          ...
          boxShadow: "0px 2px 10px " + colors.primary.dark,
        },
        scrollableX: {
    ...
    MuiTimelineDot: {
      styleOverrides: {
        ...
        outlined: {
          backgroundColor: colors.alpha.black[100],
          boxShadow: "0 0 0 6px " + colors.alpha.black[100],
        },
        outlinedPrimary: {
          backgroundColor: colors.alpha.black[100],
          boxShadow: "0 0 0 6px " + colors.alpha.black[100],
